...
class Version20110613224537 extends AbstractMigration {
	...
	public function up(Schema $schema) {
		...
		$this->addSql("ALTER TABLE flow3_security_account ADD FOREIGN KEY (party_abstractparty) REFERENCES party_abstractparty(flow3_persistence_identifier)");
		$this->addSql("ALTER TABLE party_person ADD FOREIGN KEY (party_personname) REFERENCES party_personname(flow3_persistence_identifier)");
		$this->addSql("ALTER TABLE party_person ADD FOREIGN KEY (party_electronicaddress) REFERENCES party_electronicaddress(flow3_persistence_identifier)");
		$this->addSql("ALTER TABLE party_person ADD FOREIGN KEY (flow3_persistence_identifier) REFERENCES party_abstractparty(flow3_persistence_identifier) ON DELETE CASCADE");
		$this->addSql("ALTER TABLE party_person_electronicaddresses_join ADD FOREIGN KEY (party_person) REFERENCES party_person(flow3_persistence_identifier)");
		$this->addSql("ALTER TABLE party_person_electronicaddresses_join ADD FOREIGN KEY (party_electronicaddress) REFERENCES party_electronicaddress(flow3_persistence_identifier)");
	}
	...
	public function down(Schema $schema) {
		...
		$this->addSql("ALTER TABLE flow3_security_account DROP FOREIGN KEY ");
		$this->addSql("ALTER TABLE party_person DROP FOREIGN KEY ");
		$this->addSql("ALTER TABLE party_person DROP FOREIGN KEY ");
		$this->addSql("ALTER TABLE party_person_electronicaddresses_join DROP FOREIGN KEY ");
		$this->addSql("ALTER TABLE party_person_electronicaddresses_join DROP FOREIGN KEY ");
		$this->addSql("ALTER TABLE party_person DROP FOREIGN KEY ");
